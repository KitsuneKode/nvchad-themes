...
console.log("");
console.log("Per-theme files: themes/*-theme.json (import one into zed.dev/theme-builder).");
console.log("Hero golden extracts: zed/golden/*.json (surface regression checks).");
console.log("Per-theme JSON files are also in zed-extension/themes/{id}-theme.json for Theme Builder import.");
console.log("");
