...
export const buildZedThemeVariantFromModel = (model: ResolvedThemeModel) => {
  ...
  return {
    ...
    style: {
      ...
      "panel.overlay_hover": ui.elementHover,
      players: [
      ...
      predictive: hints.commentColor,
      "predictive.background": alpha(hints.commentColor, 0.1),
      ...
      "version_control.added_background": ladder.background,
      "version_control.conflict": git.conflict,
      "version_control.conflict_background": ladder.background,
      ...
      "version_control.deleted_background": ladder.background,
      "version_control.ignored": git.ignored,
      "version_control.modified": git.modified,
      "version_control.modified_background": ladder.background,
      "version_control.renamed": git.renamed,
      "version_control.word_added": alpha(git.added, 0.35),
      "version_control.word_deleted": alpha(git.deleted, 0.8),
