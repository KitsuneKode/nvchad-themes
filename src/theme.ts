...
const openCodeColor = (name: string) => ({ dark: name, light: name });

export const buildOpenCodeTheme = (theme: ThemeSpec = themeCatalog[0]): OpenCodeThemeDefinition => {
